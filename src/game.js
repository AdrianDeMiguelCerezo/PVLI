...
let config = {
	...
	scene: [MainMenu,BootScene,Map,xd, Test, BattleScene, DialogueScene, GameOver],//[{preload:preload, create:create}],	// Decimos a Phaser cual es nuestra escena, en este caso la escena es un 
