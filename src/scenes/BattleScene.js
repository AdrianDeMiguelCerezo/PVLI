...
export default class BattleScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add.rectangle(baseX-13, baseY, this.combatManager.maxActionsPerTurn * 25, 16, 0x000000, 0).setOrigin(0,0.5).setInteractive().on("pointerover", () => {
            this.ShowTextbox("Acciones restantes en este turno");
        }).on("pointerout", () => {
            this.HideTextbox();
        });
    ...
    RedrawEnemies() {
        ...
        for (let i = 0; i < this.enemiesTam; i++) {
            ...
            for (let j = 0; j < enemy.efectosTam; j++) {
                ...
                let newEfecto = new ImageWithText(
                    this,
                    0,
                    0,
                    efecto.duration,
